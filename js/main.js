jQuery(document).on('ready', function ($) {
    ...
    $('ul#nav li a[href^="#"], a.navbar-brand, a.scrolltotop').on('click', function (event) {
        ...
        var offset = 30; // el tiempo de desaparicion 
        var target = $(id).offset().top - offset;
        $('html, body').animate({
            scrollTop: target
        }, 1600, "easeInOutExpo");//tiempo de espera para iniciar a subir en la pagina y llegar al top
    ...
    jQuery('.stellarnav').stellarNav({
        theme: 'dark'//color del menú para móviles (light, dark or plain)
    });
    ...
    $homeSlider.owlCarousel({
        merge: true,
        smartSpeed: 1000,//velocidad de transicion en milisegundos
        loop: true,//bucle
        nav: true,//botones de navegación
        navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
        autoplay: true,//cambiar automaticamente
        autoplayTimeout: 3000, //velocidad de cambio en milisegundos
        margin: 0,
        /*animateIn: 'fadeIn',
        animateOut: 'fadeOut',*/
